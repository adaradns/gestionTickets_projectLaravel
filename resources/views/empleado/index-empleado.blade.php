...
<body>
    ...
    <div id="empleadoLinea1">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                    <h4 class="page-header"><a href="index-empleado1.html"> Listar tickets asignados </a>/</h4>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
                ...
                <div class="col-lg-12">
                    ...
                    <div class="panel panel-primary">
                        <div class="panel-heading ">
                            <i class="fa fa-ticket fa-fw"></i>Tickets asignados
                        </div>
                        <div class="panel-body">
                                      ...
                                      <table class="table table-bordered table-hover table-striped">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>Lorem Ipsum</td>
                                                    <td>Finalizado a<i class=" fa fa-check-square fa-fw"></i></td>
                                                    <td><p class="success">Bajo</p></td>
                                                    <td><a href="descipcion-empleado1.html"><button class="pull-right btn info"><i class="fa fa-eye" aria-hidden="true"></i></button></a></td>
                                                </tr>
                                                <tr>
                                                    <td>Lorem Ipsum</td>
                                                    <td>Asignado</td>

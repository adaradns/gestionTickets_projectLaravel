                        ...
                        <tbody>
                            ...
                            <tr data-titulo="{{$ticket->titulo}}" 
                               ...
                               <td>
                                    ...
                                    <!--Btn Editar-->
                                    <a href="{{url('empleado/descripcionAutoasignar',$ticket->id)}}" class="btn btn-warning link-color hidden-xs " data-toggle="tooltip" title="Panel de informacion"><i class="fa fa-ticket" aria-hidden="true"></i> </a>
                                </td>
                            </tr>
                             @endforeach
                        </tbody>
